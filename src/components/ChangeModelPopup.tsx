...
interface ChangeModelPopupProps {
  isOpen: boolean
  onClose: () => void
}

const ChangeModelPopup: React.FC<ChangeModelPopupProps> = ({ isOpen, onClose }) => {
  ...
  const phoneModels = {
    ...
    samsung: [
      ...
      'Galaxy', 'Google Nexus S', 'Gravity 2', 'Gravity 3', 'Gravity Q', 'Gravity Smart',
      'Gravity Touch', 'Gravity Txt', 'Highlight', 'Impression', 'Infuse 4G', 'Innov8',
      'Juke', 'Matrix', 'Memoir', 'Omnia 2', 'Omnia 7', 'Omnia HD', 'Omnia Pro 4',
      'Omnia', 'Pixon', 'Rugby 3', 'Rugby 4', 'Rugby Smart', 'S8000 Jet', 'S8300 UltraTouch',
      'Serenata Bang and Olufsen', 'Serene', 'Solstice 2', 'Solstice', 'Star', 'Stripe',
      'Sync', 'Vibrant', 'Wave', 'B3310', 'B7620 Giorgio Armani', 'Captivate Glide',
      'Comeback', 'Continuum', 'Corby Plus', 'Corby', 'Dart', 'Evergreen', 'Fight 2',
      'Fight', 'Focus 2', 'Focus Flash', 'Focus S', 'GH A197', 'GH C225', 'GH F480 Tocco',
      'GH T109', 'GH T119', 'GH T139', 'GH T159', 'GH T209', 'GH T219', 'GH T229',
      'GH T239', 'GH T249'
    ],
    google: [
  ...
  const tabletModels = {
    ...
    samsung: [
      ...
      'Galaxy Tab A 7.0 (2016)', 'Galaxy Tab E 9.6', 'Galaxy Tab E 8.0', 'Galaxy Tab Pro 12.2',
      'Galaxy Tab Pro 10.1', 'Galaxy Tab Pro 8.4', 'Galaxy Tab Pro S', 'Galaxy Tab 8.9',
      'Galaxy Tab 7.7', 'Galaxy Tab 7.0 Plus', 'Galaxy Tab 7.0', 'Galaxy Tab 4 10.1',
      'Galaxy Tab 4 8.0', 'Galaxy Tab 4 7.0', 'Galaxy Tab 4 Nook 7.0', 'Galaxy Tab 3 10.1',
      'Galaxy Tab 3 8.0', 'Galaxy Tab 3 7.0 Kids', 'Galaxy Tab 3 7.0 Garnet Red',
      'Galaxy Tab 3 Lite 7.0', 'Galaxy Tab 2 10.1', 'Galaxy Tab 2 7.0', 'Galaxy Tab 10.1',
      'Galaxy Note 10.1 (2014 Edition)', 'Galaxy Note 10.1', 'Galaxy Note 8.0',
      'Galaxy Note Pro', 'Galaxy View', 'Galaxy View 2', 'Galaxy J Max', 'ATIV Tab 3',
      'ATIV Tab 5', 'ATIV Tab 7', 'ATIV Tab Q', 'ATIV Tab', 'Google Nexus 10',
      'Q1 Ultra', 'Q1'
    ]
  }
  ...
  const smartwatchModels = {
    apple: [
      ...
      'Watch Series 3 42mm Aluminium GPS Only', 'Watch Series 3 42mm Stainless Steel GPS Only',
      'Watch Nike Plus Series 3 38mm GPS And Cellular', 'Watch Series 3 38mm Aluminium GPS Only',
      'Watch Series 3 38mm Stainless Steel GPS Only', 'Watch Series 2 42mm Stainless Steel',
      'Watch Nike Plus Series 3 42mm GPS Only', 'Watch Series 2 42mm Aluminium',
      'Watch Nike Plus Series 3 38mm GPS Only', 'Watch Series 2 38mm Stainless Steel',
      'Watch Nike Plus Series 2 42mm', 'Watch Series 2 38mm Aluminium',
      'Watch Nike Plus Series 2 38mm', 'Watch Sport Series 1 42mm', 'Watch 1st Gen 42mm',
      'Watch Sport Series 1 38mm', 'Watch Sport 1st Gen 42mm', 'Watch 1st Gen 38mm',
      'Watch Sport 1st Gen 38mm'
    ],
    samsung: [
  ...
  const getAvailableBrands = () => {
    ...
    return brands[selectedCategory as keyof typeof brands] || []
  }

  // Get available models based on category and brand
  const getAvailableModels = () => {
    if (!selectedCategory || !selectedBrand) return []
    
    if (selectedCategory === 'phone') {
      return phoneModels[selectedBrand as keyof typeof phoneModels] || []
    } else if (selectedCategory === 'tablet') {
      return tabletModels[selectedBrand as keyof typeof tabletModels] || []
    } else if (selectedCategory === 'smartwatch') {
      return smartwatchModels[selectedBrand as keyof typeof smartwatchModels] || []
    } else if (selectedCategory === 'computer') {
      return computerModels[selectedBrand as keyof typeof computerModels] || []
    }
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Navigate to the appropriate individual page
    window.location.href = `/repair/${slug}`
  }
...
export default ChangeModelPopup
